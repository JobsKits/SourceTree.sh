...
# - 核心用途：执行“用VSCode打开@openjdk64-17.0.16”对应的本机环境配置任务。
...
<<<<<<< HEAD
  # 检查 ensure jenv 所需条件，不满足时阻止继续执行。
=======
  # 检查当前运行条件是否满足后续流程要求。
>>>>>>> 9491b75b9ce08b1f889c0329325763a4360af6ac
  ensure_jenv() {
...
<<<<<<< HEAD
  # 检查 ensure jdk17 所需条件，不满足时阻止继续执行。
=======
  # 检查当前运行条件是否满足后续流程要求。
>>>>>>> 9491b75b9ce08b1f889c0329325763a4360af6ac
  ensure_jdk17() {
...
<<<<<<< HEAD
  # 执行 open vscode 对应的独立业务步骤。
=======
  # 封装 open_vscode 对应的独立处理逻辑。
>>>>>>> 9491b75b9ce08b1f889c0329325763a4360af6ac
  open_vscode() {
    local target="."
