...
- 本自述文件对应脚本：`【MacOS@SourceTree】用VSCode打开@openjdk64-17.0.16.command`。
...
| 项目 | 说明 |
|---|---|
| 脚本名称 | `【MacOS@SourceTree】用VSCode打开@openjdk64-17.0.16.command` |
...
```shell
chmod +x './【MacOS@SourceTree】用VSCode打开@openjdk64-17.0.16.command'
'./【MacOS@SourceTree】用VSCode打开@openjdk64-17.0.16.command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS@SourceTree】用VSCode打开@openjdk64-17.0.16.log`。
