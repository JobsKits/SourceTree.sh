...
- 本自述文件对应脚本：`【MacOS@SourceTree】♻️双击Git（识别子Git） 提交回退.command`。
...
```shell
chmod +x './【MacOS@SourceTree】♻️双击Git（识别子Git） 提交回退.command'
'./【MacOS@SourceTree】♻️双击Git（识别子Git） 提交回退.command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS@SourceTree】♻️双击Git（识别子Git） 提交回退.log`。
