...
- 本自述文件对应脚本：`【MacOS@SourceTree】📦双击打包Flutter.iOS.command`。
...
```shell
chmod +x './【MacOS@SourceTree】📦双击打包Flutter.iOS.command'
'./【MacOS@SourceTree】📦双击打包Flutter.iOS.command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS@SourceTree】📦双击打包Flutter.iOS.log`。
