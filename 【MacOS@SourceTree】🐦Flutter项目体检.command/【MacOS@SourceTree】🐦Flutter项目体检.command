#!/bin/zsh
# 脚本自述：
# - 脚本名称：【MacOS@SourceTree】🐦Flutter项目体检.command
# - 核心用途：执行“🐦Flutter项目体检”对应的移动端项目自动化任务。
