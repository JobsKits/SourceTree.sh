# `【MacOS@SourceTree】用Trea打开.command`
...
- 本自述文件对应脚本：`【MacOS@SourceTree】用Trea打开.command`。
...
| 项目 | 说明 |
|---|---|
| 脚本名称 | `【MacOS@SourceTree】用Trea打开.command` |
...
```shell
chmod +x './【MacOS@SourceTree】用Trea打开.command'
'./【MacOS@SourceTree】用Trea打开.command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS@SourceTree】用Trea打开.log`。
