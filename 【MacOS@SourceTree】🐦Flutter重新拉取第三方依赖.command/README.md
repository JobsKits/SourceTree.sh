...
- 本自述文件对应脚本：`【MacOS@SourceTree】🐦Flutter重新拉取第三方依赖.command`。
...
```shell
chmod +x './【MacOS@SourceTree】🐦Flutter重新拉取第三方依赖.command'
'./【MacOS@SourceTree】🐦Flutter重新拉取第三方依赖.command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS@SourceTree】🐦Flutter重新拉取第三方依赖.log`。
