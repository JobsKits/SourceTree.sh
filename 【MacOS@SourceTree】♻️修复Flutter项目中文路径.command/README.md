...
- 本自述文件对应脚本：`【MacOS@SourceTree】♻️修复Flutter项目中文路径.command`。
...
```shell
chmod +x './【MacOS@SourceTree】♻️修复Flutter项目中文路径.command'
'./【MacOS@SourceTree】♻️修复Flutter项目中文路径.command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS@SourceTree】♻️修复Flutter项目中文路径.log`。
