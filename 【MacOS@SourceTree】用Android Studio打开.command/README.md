# `【MacOS@SourceTree】用Android Studio打开.command`
...
- 本自述文件对应脚本：`【MacOS@SourceTree】用Android Studio打开.command`。
...
```shell
chmod +x './【MacOS@SourceTree】用Android Studio打开.command'
'./【MacOS@SourceTree】用Android Studio打开.command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS@SourceTree】用Android Studio打开.log`。
