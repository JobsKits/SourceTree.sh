...
- 本自述文件对应脚本：`【MacOS@SourceTree】（只打开当前目录）用Xcode打开.command`。
...
```shell
chmod +x './【MacOS@SourceTree】（只打开当前目录）用Xcode打开.command'
'./【MacOS@SourceTree】（只打开当前目录）用Xcode打开.command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS@SourceTree】（只打开当前目录）用Xcode打开.log`。
