# `【MacOS@SourceTree】用Trae打开@openjdk64-17.0.16.command`
...
- 本自述文件对应脚本：`【MacOS@SourceTree】用Trae打开@openjdk64-17.0.16.command`。
...
```shell
chmod +x './【MacOS@SourceTree】用Trae打开@openjdk64-17.0.16.command'
'./【MacOS@SourceTree】用Trae打开@openjdk64-17.0.16.command'
```
